...
export const BlogData = [
    {
        ...
        content:{
            ...
            par9 : "2. Himawan Nurcahyanto Peraih Beasiswa Excellent Researcher Scholarship Program 2020 - Kookmin University South Korea.",
            par10 : "3. Helmi Fauzi ex-Field Engineer at Leading Global Oil & Gas Services Company",
            par11 : "Diakhir sesi juga bakal ada SIMULASI FGD loh! Yuk! Jangan ketinggalan! Kapan lagi, dapat ilmu yang bermanfaat, sekaligus bisa ikutan bantu penanganan COVID-19 dan UMKM yang terdampak.",
            par12 : "Catat tanggal dan waktunya yaaa:",
            par13 : "🗓 Minggu, 22 Agustus 2021",
            par14 : "🕘 09.00-12.00 WIB",
            par14 : "📍 ZOOM Meeting",
            par15 : "⏳GRATIS & KUOTA TERBATAS!!! Segera daftarkan diri kalian di link berikut https://bit.ly/DaftarCharityWebinar",
    ...
    },
    {
        ...
        content:{
            ...
            par3 : "Pertama-tama gue ngurus semua dokumen gue buat di translate kedalam Bahasa inggris seperti National Identity (You and Both your parents), Birth Certificate (You and Both your parents), Family Card, Graduation Certificate, Transcript. Kemarin gue translate di salah satu translator di daerah Lenteng Agung Jakarta dan biayanya sekitar 1,5 jt rupiah. Proses translate nya ini memakan waktu selama 7 hari. Setelah semua dokumen gue sudah selesai di translate, gue datang ke notaris, ini bisa notaris mana aja asal nama notarisnya tertera di website kemenkumham, jadi ada baiknya temen-temen cek dulu nama notaris yang temen-temen datengin ada di website kemenkumham apa engga, karena nanti pas proses pengajuan cap/sticker di kemenkumham itu temen-temen perlu isi data online yang mencakup nama notarisnya. Buat tanda tangan dan cap notaris ini gue memerlukan waktu sekitar 2-3 hari. Setelah selesai dari notaris, gue scan semua dokumen-dokumen gue dan mengisi application di websitenya kemenkumham. Kita tunggu sampai dapet approval dari website kemenkumham, setelah sudah di informasikan bahwa sticker kemenkumhamnya sudah ready baru kita bisa datang ke kantor kemenkumhamnya, buat pembayarannya bisa langsung bayar di teller bank disana. Gue dateng ke kantor kemenkumham yang di cikini, dan ini prosesnya cukup cepat menurut gue mungkin total sekitar setengah jam sampai 1 jam gue nunggu disana. ",
            par4 : "Selanjutnya temen-temen scan lagi dokumen-dokumen yang sudah di tempelkan sticker dari kemenkumham, dan kali ini kita melalui proses buat dapet cap kemenlu. Oke, buat dapet cap kemenlu, temen-temen bisa download aplikasi kemenlu di playstore dan bisa daftar dari aplikasi kemenlu. Inget ya Cuma bisa di android (playstore) kemarin gue gabisa soalnya coba pake iphone, mungkin belum support pada saat itu. Nah setelah temen-temen daftar di aplikasi kemenlu, silahkan tunggu sekitar 1-2 hari untuk menunggu konfirmasi dari kemenlu. Jika sudah di konfirmasi kemenlu, temen-temen bisa langsung dateng ke kantor kemenlu buat dapetin cap/approval dari kemenlu. Waktu itu gue dateng ke kantor kemenlu yang di deket stasiun gondangdia Jakarta. ",
    ...
    },
    {
        ...
        content:{
            par1 : "In the electricity system, maintaining the maximum level of reliability of the electric power system will be very meaningful to reduce the cost of electricity production delivered to consumers. On the other hand, reliable and efficient maintenance of electric power systems is very important for distribute of electrical energy to consumers and meeting regulatory requirements. The transmission system is a process for distribute of electrical energy from the start of the generation system. Power transformer assets have a very dominant role in an electric power transmission system.",
            par2 : "Power transformers are the main components in regulating voltage in an electric power system. Every damage to the transformer decreases its performance which not only results in direct replacement costs, but also results in disruption of overall performance and loss of opportunity to sell electricity. Therefore, maintenance of the power transformer is needed to maintain the optimum performance quality of the transformer.",
            par3 : "One indicator that can be used as a reference in determining the quality of a transformer is its health index. In detail, the transformer health index is a comprehensive assessment of the condition of the transformer and an objective and quantitative scientific approach. In general, the health conditions of transformers are influenced by several factors, such as electrical, mechanical, and chemical factors. The diversity of transformer conditions and parameter testing (transformer oil, furans and dissolved gases) raises an assessment related to the health transformer index. In the end this can be used as a basis for concluding the overall condition of the power transformer [1].",
            par4 : "Combined observations from operating observations, field inspections, and laboratory tests can be used as references in the evaluation of transformer conditions. One of the challenges is how to translate the test measurement data with its importance and influence on the health condition of the transformer. In the literature, several learning studies on health index methods refer to industry standards and expert judgment [1]. This study discusses the data from transformer testing at PT. PLN (Persero) Certification Center, which the test is carried out on the Power Transformers to determine the health index of the transformer. There are several studies that discuss  the transformers lifetime, but hopefully this study can be more comprehensive because it uses the data from the overall test results of the transformer. The tests include the transformer oil, furans and dissolved gases. This study was aimed to obtain  the predictions of the life of Power Transformers using Artificial Neural Network applications based on three input tests carried out on the transformer.",
            par5 : "After calculating each parameter, the artificial neural network was finally able to model the history of the transformer, so that it could directly predict the life of transformer, both the new transformer and the operating one. In the final assessment there were several values. The values can be classified in three types of results, namely: (a) a conditions where the calculation of health index transformer was in accordance with the calculation of artificial neural networks; (b) a condition of the calculation of health index transformer was close to the calculation of artificial neural networks; and (c) a condition of the calculation of health index transformer was a little far from the calculation of artificial neural networks.",
            par6 : "Artificial neural networks in this research succeeded in modeling the results of the total health transformer index, to be used as program input reference data. In this study artificial neural networks used the backpropagation feedforward method, where the results of the prediction have approached the calculation value of the transformer health index which has been a representation of the condition of the transformer. The error value in this study was quite low, in which the output value and target for the testing of artificial neural networks were  compared and the errors were searched using the Mean Square Error method. This method is used to minimize the occurrence of errors in the prediction of the life of the transformer. So, in this study, the Mean Square Error obtained for the prediction of 50 transformer units in the dissolved gas test was 0.0020, in the transformer insulating oil was 0.000934, and the transformer final value was 0.0022.",
            par7 : "Reference :",
